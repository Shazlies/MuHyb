 ...
 * @author Shad0o0
 */
public class oneWayDataBindingReplacement {
    ...
    public static void main(String[] args) {
        File f = new File("D:\\projects2\\infoapp\\src\\app\\pages\\info-details\\info-details.page.html");
        oneWayDataBindingReplacement eo = new oneWayDataBindingReplacement();
...
//                }
            ...
            sc.close();
            System.out.println(mutationPart.size());
...
//            System.out.println(line.length());
            for (int i = 0; i < line.length(); i++) {
                ...
                if (a == '[' && !f1Bool && !f2Bool && !f3Bool && !f4Bool) {
...
//                    System.out.println(i);
                ...
                if (a == ']' && f1Bool && !f2Bool && !f3Bool && !f4Bool && i > f1 + 2) {
