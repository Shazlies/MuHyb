...
public class LogicalOperators {
    ...
    ArrayList<String> logicalOperators = new ArrayList<String>(); // this list contains the output of mutants
        ...
        try {
            ...
            while (sc.hasNext()) {
                ...
                for (int i = 0; i < logicalOperators.size(); i++) {
                    String o = logicalOperators.get(i) + line + "\n";
                    logicalOperators.set(i, o);
                }
            ...
            if (!logicalOperators.isEmpty()) {
                ...
                gm.generateFiles(logicalOperators, originalFiles, mutantInformation, threadNumbers);
            }
    ...
    public void setOperator(String line, String output1, File file, int lineNumber, String originalOperator, String operatorReplacement, String fisrtOperator) {
        ...
        for (int i = 0; i < number; i++) {
            ...
            if (!firstPossibility[i].contains("$^%&%&")) {
                ...
                MutantInformation m = new MutantInformation(lineNumber, "Logical Operator", line, firstPossibility[i]);
                mutantInformation.add(m);
                logicalOperators.add(output1 + firstPossibility[i] + "\n");
