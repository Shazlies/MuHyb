 ...
 * @author Shad0o0
 */
public class oneWayDataBindingReplacement2 {
    ...
    public static void main(String[] args) {
        ...
        oneWayDataBindingReplacement2 eo = new oneWayDataBindingReplacement2();
                    ...
                    for (int i = 0; i < this.lineNumber.size(); i++) {
                        if (counter == this.lineNumber.get(i)) {
                            for (int j = 0; j < mutationPart.size(); j++) {
                                //System.out.println("ASDASD " + mutationPart.get(i));
                                //System.out.println("ASDASD " + mutationPart.get(j));
